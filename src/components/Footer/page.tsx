...
const FooterSection = () => {
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-6 px-5 py-8 md:flex-row md:justify-between md:items-center md:px-10 md:py-11.25 lg:px-15">
